namespace Spoon.NuGet.Core.Application.Mediator.PipelineBehaviors.Permission.Assistants
{
    using EitherCore;
    ...
    public class PermissionPipelineBehaviourAssistant : IPermissionPipelineBehaviourAssistant
    {
        ...
        public EitherException CreateEitherException<TRequest>(TRequest request, string origin, string message, int httpStatusCodes)
        {
